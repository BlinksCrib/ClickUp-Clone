        ...
        <div className="flex justify-center items-center w-[90%] mt-[8rem] mb-[3rem] overflow-hidden">
          <div className="relative">
            <div className="rounded-full w-[620px] h-[620px] bg-[rgba(255,255,255,0.9)] flex justify-center items-center team-together_cont">
              <aside className="w-4/5 h-4/5 flex justify-center items-center text-center flex-col">
                <h1 className="testing-gradient text-5xl font-extrabold">
                ...
                <button
                  className=" px-[8rem] py-3 rounded-lg font-bold text-xl text-[#ffffff]"
                  style={{
                    background:
